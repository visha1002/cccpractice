...
<body>
    <form action="/practice/form.php" method="post">
        <div class="center">
            ...
            <div class="form-group row">
                <label for="">SKU : </label>
                <input style="margin-left:80px" type="text" placeholder="Enter your product SKU number" name="Sku"
                    id="">
            </div>
            ...
            <div class="form-group-row radiobtn">
                ...
                <button style="width:15%; margin:15px; margin-left:150px" type="submit" name="submit"
